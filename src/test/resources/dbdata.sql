...
INSERT INTO services (id, version, vat_amount, total_amount, service_type, customer_id, address_id, timestamp, amount) VALUES (1, null, 20.00, 120.00, 'ShopPurchase', 1, 1, '2016-11-19 13:25:50', 100.00);
INSERT INTO services (id, version, vat_amount, total_amount, service_type, customer_id, address_id, timestamp, amount) VALUES (2, null, 40.00, 240.00, 'AdvancePayment', 1, 2, '2016-11-19 13:26:36', 200.00);
INSERT INTO services (id, version, vat_amount, total_amount, service_type, customer_id, address_id, timestamp, amount) VALUES (3, null, 40.00, 240.00, 'AdvancePayment', 3, 3, '2016-02-19 13:26:36', 200.00);
INSERT INTO services (id, version, vat_amount, total_amount, service_type, customer_id, address_id, timestamp, amount) VALUES (4, null, 40.00, 240.00, 'AdvancePayment', 3, 2, '2016-11-19 13:26:36', 200.00);
INSERT INTO services (id, version, vat_amount, total_amount, service_type, customer_id, address_id, timestamp, amount) VALUES (5, null, 40.00, 240.00, 'AdvancePayment', 3, 3, '2016-11-19 13:26:36', 200.00);
INSERT INTO services (id, version, vat_amount, total_amount, service_type, customer_id, address_id, timestamp, amount) VALUES (6, null, 20.00, 120.00, 'ShopPurchase', 3, 1, '2016-11-19 13:25:50', 100.00);
INSERT INTO services (id, version, vat_amount, total_amount, service_type, customer_id, address_id, timestamp, amount) VALUES (7, null, 40.00, 240.00, 'AdvancePayment', 3, 3, '2016-11-19 13:26:36', 200.00);