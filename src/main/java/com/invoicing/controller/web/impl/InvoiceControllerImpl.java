package com.invoicing.controller.web.impl;

import com.invoicing.controller.web.InvoiceController;
...
class InvoiceControllerImpl implements InvoiceController {
    ...
    @RequestMapping(value = "/generateMonthlyInvoices", method= RequestMethod.POST)
    @Override
    public void generateMonthlyInvoices(@Valid @RequestBody RequestDto dto) {
